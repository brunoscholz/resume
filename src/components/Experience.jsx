  ...
  const items = [
    {
      ...
      points: ['Over 700 videos', 'Over 80M Views', 'Nearly 1 Million Subscribers'],
      image: 'https://yt3.ggpht.com/ytc/AKedOLQXx-JXf1NsSUtVHcYhx4B4MaIYE0m7I_H0GHmu-w=s900-c-k-c0x00ffffff-no-rj'
    },
    {
      title: 'Software Engineer',
      company: 'Microsoft',
      date: 'May 2020 - August 2020',
      description: 'Built data science related features in the Python extension for VSCode.',
      points: [],
