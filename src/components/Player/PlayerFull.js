...
const PlayerFull = ({ morphs, ...props }) => {
  return (
    <Link to='/' {...props} className='no-underline'>
      <div className='bg-white shadow-lg rounded-lg' {...morphs.container}>
        <div className='flex'>
          ...
          <div className='w-3/5 sm:w-1/2 p-4'>
            <div className='flex justify-between'>
              <div>
                <h1
                  className='text-2xl md:text-3xl m-0 mb-1 text-grey-darkest leading-none font-medium whitespace-no-wrap'
                  {...morphs.title}
                >
                  A Sky Full of Stars
                </h1>
                <p className='text-sm text-grey-dark m-0 float-left' {...morphs.subtitle}>
                  Ghost Stories
                </p>
              </div>
